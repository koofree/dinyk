...
export interface DinTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "isMaxSupplyReached",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace MaxSupplyReachedEvent {
  export type InputTuple = [totalSupply: BigNumberish];
  export type OutputTuple = [totalSupply: bigint];
  export interface OutputObject {
    totalSupply: bigint;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface DinToken extends BaseContract {
  connect(runner?: ContractRunner | null): DinToken;
  ...
  isMaxSupplyReached: TypedContractMethod<[], [boolean], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "isMaxSupplyReached"
  ...
  >;
  getEvent(
    key: "MaxSupplyReached"
  ): TypedContractEvent<
    MaxSupplyReachedEvent.InputTuple,
    MaxSupplyReachedEvent.OutputTuple,
    MaxSupplyReachedEvent.OutputObject
  >;
  getEvent(
    key: "Paused"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "MaxSupplyReached(uint256)": TypedContractEvent<
      MaxSupplyReachedEvent.InputTuple,
      MaxSupplyReachedEvent.OutputTuple,
      MaxSupplyReachedEvent.OutputObject
    >;
    MaxSupplyReached: TypedContractEvent<
      MaxSupplyReachedEvent.InputTuple,
      MaxSupplyReachedEvent.OutputTuple,
      MaxSupplyReachedEvent.OutputObject
    >;
