...
export interface DinUSDTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_UINT"
      | "addBlackList"
  ...
  encodeFunctionData(
    functionFragment: "getUpgradedAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DinUSDT extends BaseContract {
  connect(runner?: ContractRunner | null): DinUSDT;
  waitForDeployment(): Promise<this>;

  interface: DinUSDTInterface;
  ...
  getUpgradedAddress: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "getUpgradedAddress"
